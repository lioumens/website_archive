...
# Import C++ code
sourceCpp('stochastic/cpp_funcs.cpp')
...
# 9 point stencil, that is weighted sum of the standard 1 1 -4 1 1 stencil.
...
# Implements Neumann boundary conditions (reflecting)
...
# Do the plot
p <- ggplot(data = df, aes(x = x, y = y, fill= B)) + 
