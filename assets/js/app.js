(function($) {
 ...
 function init() {
    ...
    // Annoying behavior with secondary contact lists
    ...
    /* Added "/categories" so I could move categories.html into directory */

    function activateTab() {
      if(['/tags.html', '/categories.html','/categories/'].indexOf(window.location.pathname) > -1) {
